...
<body>
    ...
    <div class="card-secton topup-content">
        <form class="forms-sample" method="post" action="../query/tambah_pesanan.php" enctype="multipart/form-data">
            <div class="tf-container">
                <div class="tf-balance-box">
                    ...
                    <div class="tf-form">
                        <div class="group-input input-field input-money">
                            ...
                            <select name="id_konsumen" class="box-sl-profile form-select">
                                <option></option>
                                <?php
                                $data_status = mysqli_query($koneksi, "SELECT * FROM `tb_user` WHERE id>1");
