...
<body class="bg_surface_color">
    <div class="header is-fixed">
        <div class="tf-container">
            <div class="tf-statusbar d-flex justify-content-center align-items-center">
                <a href="proses" class="back-btn"> <i class="icon-left"></i> </a>
                <h3>Proses Cucian</h3>
            </div>
        </div>
    </div>
    ...
    ?>
        <form class="forms-sample" method="post" action="function/kandidat_edit.php" <div id="app-wrap">
            <div class="bill-payment-content">
                <div class="tf-container">
                    <div class="mt-3 bill-topbar">
                        ...
                        <h4 class="fw_6"><?php echo $d['nama_barang']; ?></h4>
                    </div>
                    <div class="wrapper-bill">
                        <div class="archive-top">
                            ...
                            <h1><a href="#" class="critical_color"><?php echo $d['nama_barang']; ?></a></h1>
                            <h3 class="mt-2 fw_6">Tanggal Masuk <?php echo $d['tgl_masuk']; ?></h3>
                            <!-- <p class="fw_4 mt-2">Pemilik <?php echo $d['nama_konsumen']; ?></p> -->
                        </div>
                        <!-- <div class="dashed-line"></div>
                        <div class="archive-bottom">
                            <h2 class="text-center">Customer Information</h2>
                            <ul>
                                <li class="list-info-bill">Customer's Code <span>PD123456789</span> </li>
                                <li class="list-info-bill">Customer Name <span>Themesflat</span> </li>
                                <li class="list-info-bill">Address <span class="text-end">themesflat@gmail.<br> com</span> </li>
                            </ul>
                        </div> -->
        ...
        <div class="bottom-navigation-bar st1 bottom-btn-fixed">
            <div class="tf-container">
                <a href="../query/proses_antrian.php?id= <?php echo $d['id']; ?>" class="tf-btn accent large">Selesai dan Simpan</a>
            </div>
        </div>
