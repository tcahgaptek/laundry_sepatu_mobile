    ...
    <div class="app-header st1">
        <div class="tf-container">
            <div class="tf-topbar d-flex justify-content-center align-items-center">
                ...
                <h3 class="white_color">Transaksi Selesai</h3>
            </div>
        </div>
    </div>
            ...
            <div class="bill-content">
                <div class="tf-container">
                    ...
                    <ul class="mt-3 mb-5">
                        <?php
                        $no = 1;
                        $data = mysqli_query($koneksi, "SELECT * FROM `vw_transaksi` where status ='lunas'");
                        ...
                        ?>
                                <li class="list-card-invoice">
                                    ...
                                    <div class="content-right">
                                        <h4><a href="invoice.php?id=<?php echo $s['id']; ?>"><?php echo $s['nama_barang']; ?></h4>
