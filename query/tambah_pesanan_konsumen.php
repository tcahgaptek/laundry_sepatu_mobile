...
if (isset($_POST['simpan'])) {
    ...
    move_uploaded_file($_FILES['foto']['tmp_name'], ".../images/pesanan" . $_FILES['foto']['name']);
    ...
    if ($query_run) {
        ...
        header("Location: ../konsumen/index.php?pesan=berhasil");
    } else {
        $_SESSION['status'] = "Data Not Inserted";
        header("Location: ../konsumen/index.php?pesan=gagal_simpan&id=$id");
    }
}
